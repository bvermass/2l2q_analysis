...
void draw_n_hists(TString name, TCanvas *c, std::map<TString, TH1*> hists, TString drawoptions, TLegend *lgend, TString Xaxis, TString Yaxis, double xmin, double xmax, int lin0log1, double ymin, double ymax, TString toprighttitle);
