...
LSFReader::LSFReader(const TString filename_LSF, const TString histoname_LSF, const TString histoname_sys, const TString pt_eta_conf, const double pt_mx){
    ...
    if(pt_eta_conf != "eta_pt" and pt_eta_conf != "pt_abseta" and pt_eta_conf != "abseta_pt") std::cout << "Lepton Scale Factor: pt_eta_configuration not recognized: " << pt_eta_conf << std::endl;
