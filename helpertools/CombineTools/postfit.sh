...
combine --cminDefaultMinimizerStrategy 0 --saveShapes --saveWithUncertainties --name _OS_2l_M-6_V2-2e-06_run2_dirac -M FitDiagnostics /user/bvermass/public_html/2l2q_analysis/combine_observed_NTight/datacards/M-6_2l_run2_dirac/_OS_2l_M-6_V2-2e-06_cutNTightmlSV_quadA_Shape_SR.txt
...
combine --cminDefaultMinimizerStrategy 0 --saveShapes --saveWithUncertainties --name _OS_2l_M-12_V2-2e-06_run2_dirac -M FitDiagnostics /user/bvermass/public_html/2l2q_analysis/combine_observed_NTight/datacards/M-12_2l_run2_dirac/_OS_2l_M-12_V2-2e-06_cutNTightmlSV_quadA_Shape_SR.txt
