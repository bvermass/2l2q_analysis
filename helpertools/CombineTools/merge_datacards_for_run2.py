...
for root, dirs, files in os.walk(datacardDir):
    for f in files:
        ...
        if '_M-' in f and '_V2-' in f and '.txt' in f and '2016' in f_2016:
            ...
            #os.system('python /user/bvermass/heavyNeutrino/Dileptonprompt/CMSSW_10_2_13/src/HiggsAnalysis/CombinedLimit/scripts/combineCards.py Name1={} Name2={} Name3={} > {}'.format(f_2016, f_2017, f_2018, f_run2))
            os.system('python /user/bvermass/heavyNeutrino/Dileptonprompt/CMSSW_10_2_13/src/HiggsAnalysis/CombinedLimit/scripts/combineCards.py Name1={} Name2={} > {}'.format(f_2016, f_1718, f_run2))
