...
void Skimmer::Init_input_branches(TTree* tree)
{
    ...
    if(!isData){
         ...
         tree->SetBranchAddress("_gen_NPackedDtrsRecodR", &i_gen_NPackedDtrsRecodR, &bi__gen_NPackedDtrsRecodR);
         tree->SetBranchAddress("_gen_NPackedDtrsRecodptoverpt", &i_gen_NPackedDtrsRecodptoverpt, &bi__gen_NPackedDtrsRecodptoverpt);
         ...
         tree->SetBranchAddress("_gen_NPackedDtrsRecodxy", &i_gen_NPackedDtrsRecodxy, &bi__gen_NPackedDtrsRecodxy);
         tree->SetBranchAddress("_gen_NPackedDtrsRecodz", &i_gen_NPackedDtrsRecodz, &bi__gen_NPackedDtrsRecodz);
         tree->SetBranchAddress("_gen_NPackedDtrsHasReco", &i_gen_NPackedDtrsHasReco, &bi__gen_NPackedDtrsHasReco);
         tree->SetBranchAddress("_gen_nNPackedDtrsPCA", &i_gen_nNPackedDtrsPCA, &bi__gen_nNPackedDtrsPCA);
         tree->SetBranchAddress("_gen_NPackedDtrsPCADist", &i_gen_NPackedDtrsPCADist, &bi__gen_NPackedDtrsPCADist);
         tree->SetBranchAddress("_gen_NPackedDtrsPCAX0", &i_gen_NPackedDtrsPCAX0, &bi__gen_NPackedDtrsPCAX0);
         tree->SetBranchAddress("_gen_NPackedDtrsPCAY0", &i_gen_NPackedDtrsPCAY0, &bi__gen_NPackedDtrsPCAY0);
         tree->SetBranchAddress("_gen_NPackedDtrsPCAZ0", &i_gen_NPackedDtrsPCAZ0, &bi__gen_NPackedDtrsPCAZ0);
         tree->SetBranchAddress("_gen_NPackedDtrsPCAX1", &i_gen_NPackedDtrsPCAX1, &bi__gen_NPackedDtrsPCAX1);
         tree->SetBranchAddress("_gen_NPackedDtrsPCAY1", &i_gen_NPackedDtrsPCAY1, &bi__gen_NPackedDtrsPCAY1);
         tree->SetBranchAddress("_gen_NPackedDtrsPCAZ1", &i_gen_NPackedDtrsPCAZ1, &bi__gen_NPackedDtrsPCAZ1);
         tree->SetBranchAddress("_gen_NPackedDtrsPCAX2", &i_gen_NPackedDtrsPCAX2, &bi__gen_NPackedDtrsPCAX2);
         tree->SetBranchAddress("_gen_NPackedDtrsPCAY2", &i_gen_NPackedDtrsPCAY2, &bi__gen_NPackedDtrsPCAY2);
         tree->SetBranchAddress("_gen_NPackedDtrsPCAZ2", &i_gen_NPackedDtrsPCAZ2, &bi__gen_NPackedDtrsPCAZ2);
         tree->SetBranchAddress("_gen_NPackedDtrsPCAPhi1", &i_gen_NPackedDtrsPCAPhi1, &bi__gen_NPackedDtrsPCAPhi1);
         tree->SetBranchAddress("_gen_NPackedDtrsPCAPhi2", &i_gen_NPackedDtrsPCAPhi2, &bi__gen_NPackedDtrsPCAPhi2);
         tree->SetBranchAddress("_gen_NPackedDtrsPCAIndex1", &i_gen_NPackedDtrsPCAIndex1, &bi__gen_NPackedDtrsPCAIndex1);
         tree->SetBranchAddress("_gen_NPackedDtrsPCAIndex2", &i_gen_NPackedDtrsPCAIndex2, &bi__gen_NPackedDtrsPCAIndex2);
         tree->SetBranchAddress("_gen_NPackedDtrsHasKVFvertex", &i_gen_NPackedDtrsHasKVFvertex, &bi__gen_NPackedDtrsHasKVFvertex);
         tree->SetBranchAddress("_gen_NPackedDtrs_KVF_x", &i_gen_NPackedDtrs_KVF_x, &bi__gen_NPackedDtrs_KVF_x);
         tree->SetBranchAddress("_gen_NPackedDtrs_KVF_y", &i_gen_NPackedDtrs_KVF_y, &bi__gen_NPackedDtrs_KVF_y);
         tree->SetBranchAddress("_gen_NPackedDtrs_KVF_z", &i_gen_NPackedDtrs_KVF_z, &bi__gen_NPackedDtrs_KVF_z);
         tree->SetBranchAddress("_gen_NPackedDtrs_KVF_cxx", &i_gen_NPackedDtrs_KVF_cxx, &bi__gen_NPackedDtrs_KVF_cxx);
         tree->SetBranchAddress("_gen_NPackedDtrs_KVF_cyy", &i_gen_NPackedDtrs_KVF_cyy, &bi__gen_NPackedDtrs_KVF_cyy);
         tree->SetBranchAddress("_gen_NPackedDtrs_KVF_czz", &i_gen_NPackedDtrs_KVF_czz, &bi__gen_NPackedDtrs_KVF_czz);
         tree->SetBranchAddress("_gen_NPackedDtrs_KVF_cyx", &i_gen_NPackedDtrs_KVF_cyx, &bi__gen_NPackedDtrs_KVF_cyx);
         tree->SetBranchAddress("_gen_NPackedDtrs_KVF_czy", &i_gen_NPackedDtrs_KVF_czy, &bi__gen_NPackedDtrs_KVF_czy);
         tree->SetBranchAddress("_gen_NPackedDtrs_KVF_czx", &i_gen_NPackedDtrs_KVF_czx, &bi__gen_NPackedDtrs_KVF_czx);
         tree->SetBranchAddress("_gen_NPackedDtrs_KVF_df", &i_gen_NPackedDtrs_KVF_df, &bi__gen_NPackedDtrs_KVF_df);
         tree->SetBranchAddress("_gen_NPackedDtrs_KVF_chi2", &i_gen_NPackedDtrs_KVF_chi2, &bi__gen_NPackedDtrs_KVF_chi2);
         tree->SetBranchAddress("_gen_NPackedDtrs_KVF_ntracks", &i_gen_NPackedDtrs_KVF_ntracks, &bi__gen_NPackedDtrs_KVF_ntracks);
...
void Skimmer::Add_branches(TTree* tree)
{
    ...
    if(!isData){
        ...
        tree->Branch("_gen_NPackedDtrsRecodR",		    &o_gen_NPackedDtrsRecodR,		"_gen_NPackedDtrsRecodR[_gen_nNPackedDtrs]/D");
        tree->Branch("_gen_NPackedDtrsRecodptoverpt",   &o_gen_NPackedDtrsRecodptoverpt,"_gen_NPackedDtrsRecodptoverpt[_gen_nNPackedDtrs]/D");
        ...
        tree->Branch("_gen_NPackedDtrsRecodxy",         &o_gen_NPackedDtrsRecodxy,      "_gen_NPackedDtrsRecodxy[_gen_nNPackedDtrs]/D");
        tree->Branch("_gen_NPackedDtrsRecodz",          &o_gen_NPackedDtrsRecodz,       "_gen_NPackedDtrsRecodz[_gen_nNPackedDtrs]/D");
        tree->Branch("_gen_NPackedDtrsHasReco",         &o_gen_NPackedDtrsHasReco,	    "_gen_NPackedDtrsHasReco[_gen_nNPackedDtrs]/O");
        tree->Branch("_gen_nNPackedDtrsPCA",		     &o_gen_nNPackedDtrsPCA,		  "_gen_nNPackedDtrsPCA/i");
        tree->Branch("_gen_NPackedDtrsPCADist",		     &o_gen_NPackedDtrsPCADist,		  "_gen_NPackedDtrsPCADist[_gen_nNPackedDtrsPCA]/D");
        tree->Branch("_gen_NPackedDtrsPCAX0",		     &o_gen_NPackedDtrsPCAX0,		  "_gen_NPackedDtrsPCAX0[_gen_nNPackedDtrsPCA]/D");
        tree->Branch("_gen_NPackedDtrsPCAY0",		     &o_gen_NPackedDtrsPCAY0,		  "_gen_NPackedDtrsPCAY0[_gen_nNPackedDtrsPCA]/D");
        tree->Branch("_gen_NPackedDtrsPCAZ0",		     &o_gen_NPackedDtrsPCAZ0,		  "_gen_NPackedDtrsPCAZ0[_gen_nNPackedDtrsPCA]/D");
        tree->Branch("_gen_NPackedDtrsPCAX1",		     &o_gen_NPackedDtrsPCAX1,		  "_gen_NPackedDtrsPCAX1[_gen_nNPackedDtrsPCA]/D");
        tree->Branch("_gen_NPackedDtrsPCAY1",		     &o_gen_NPackedDtrsPCAY1,		  "_gen_NPackedDtrsPCAY1[_gen_nNPackedDtrsPCA]/D");
        tree->Branch("_gen_NPackedDtrsPCAZ1",		     &o_gen_NPackedDtrsPCAZ1,		  "_gen_NPackedDtrsPCAZ1[_gen_nNPackedDtrsPCA]/D");
        tree->Branch("_gen_NPackedDtrsPCAX2",		     &o_gen_NPackedDtrsPCAX2,		  "_gen_NPackedDtrsPCAX2[_gen_nNPackedDtrsPCA]/D");
        tree->Branch("_gen_NPackedDtrsPCAY2",		     &o_gen_NPackedDtrsPCAY2,		  "_gen_NPackedDtrsPCAY2[_gen_nNPackedDtrsPCA]/D");
        tree->Branch("_gen_NPackedDtrsPCAZ2",		     &o_gen_NPackedDtrsPCAZ2,		  "_gen_NPackedDtrsPCAZ2[_gen_nNPackedDtrsPCA]/D");
        tree->Branch("_gen_NPackedDtrsPCAPhi1",		     &o_gen_NPackedDtrsPCAPhi1,		  "_gen_NPackedDtrsPCAPhi1[_gen_nNPackedDtrsPCA]/D");
        tree->Branch("_gen_NPackedDtrsPCAPhi2",		     &o_gen_NPackedDtrsPCAPhi2,		  "_gen_NPackedDtrsPCAPhi2[_gen_nNPackedDtrsPCA]/D");
        tree->Branch("_gen_NPackedDtrsPCAIndex1",		     &o_gen_NPackedDtrsPCAIndex1,		  "_gen_NPackedDtrsPCAIndex1[_gen_nNPackedDtrsPCA]/i");
        tree->Branch("_gen_NPackedDtrsPCAIndex2",		     &o_gen_NPackedDtrsPCAIndex2,		  "_gen_NPackedDtrsPCAIndex2[_gen_nNPackedDtrsPCA]/i");
        tree->Branch("_gen_NPackedDtrsHasKVFvertex", &o_gen_NPackedDtrsHasKVFvertex, "_gen_NPackedDtrsHasKVFvertex/O");
        tree->Branch("_gen_NPackedDtrs_KVF_x",	   &o_gen_NPackedDtrs_KVF_x,		  "_gen_NPackedDtrs_KVF_x/D");
        tree->Branch("_gen_NPackedDtrs_KVF_y",	   &o_gen_NPackedDtrs_KVF_y,		  "_gen_NPackedDtrs_KVF_y/D");
        tree->Branch("_gen_NPackedDtrs_KVF_z",	   &o_gen_NPackedDtrs_KVF_z,		  "_gen_NPackedDtrs_KVF_z/D");
        tree->Branch("_gen_NPackedDtrs_KVF_cxx",	   &o_gen_NPackedDtrs_KVF_cxx,	  "_gen_NPackedDtrs_KVF_cxx/D");
        tree->Branch("_gen_NPackedDtrs_KVF_cyy",	   &o_gen_NPackedDtrs_KVF_cyy,	  "_gen_NPackedDtrs_KVF_cyy/D");
        tree->Branch("_gen_NPackedDtrs_KVF_czz",	   &o_gen_NPackedDtrs_KVF_czz,	  "_gen_NPackedDtrs_KVF_czz/D");
        tree->Branch("_gen_NPackedDtrs_KVF_cyx",	   &o_gen_NPackedDtrs_KVF_cyx,	  "_gen_NPackedDtrs_KVF_cyx/D");
        tree->Branch("_gen_NPackedDtrs_KVF_czy",	   &o_gen_NPackedDtrs_KVF_czy,	  "_gen_NPackedDtrs_KVF_czy/D");
        tree->Branch("_gen_NPackedDtrs_KVF_czx",	   &o_gen_NPackedDtrs_KVF_czx,	  "_gen_NPackedDtrs_KVF_czx/D");
        tree->Branch("_gen_NPackedDtrs_KVF_df",	   &o_gen_NPackedDtrs_KVF_df,	  "_gen_NPackedDtrs_KVF_df/D");
        tree->Branch("_gen_NPackedDtrs_KVF_chi2",	   &o_gen_NPackedDtrs_KVF_chi2,	  "_gen_NPackedDtrs_KVF_chi2/D");
        tree->Branch("_gen_NPackedDtrs_KVF_ntracks", &o_gen_NPackedDtrs_KVF_ntracks, "_gen_NPackedDtrs_KVF_ntracks/i");
        ...
        if(Check_SkimCondition(skimcondition)){
            ...
            if(!isData){
                ...
                for(unsigned i = 0; i < i_gen_nNPackedDtrs; i++){
                    ...
                    o_gen_NPackedDtrsRecodR[i] = i_gen_NPackedDtrsRecodR[i];
                    o_gen_NPackedDtrsRecodptoverpt[i] = i_gen_NPackedDtrsRecodptoverpt[i];
                    ...
                    o_gen_NPackedDtrsRecodxy[i] = i_gen_NPackedDtrsRecodxy[i];
                    o_gen_NPackedDtrsRecodz[i] = i_gen_NPackedDtrsRecodz[i];
                    o_gen_NPackedDtrsHasReco[i] = i_gen_NPackedDtrsHasReco[i];
                }
                o_gen_nNPackedDtrsPCA = i_gen_nNPackedDtrsPCA;
                for(unsigned i = 0; i < i_gen_nNPackedDtrsPCA; i++){
                    o_gen_NPackedDtrsPCADist[i] = i_gen_NPackedDtrsPCADist[i];
                    o_gen_NPackedDtrsPCAX0[i] = i_gen_NPackedDtrsPCAX0[i];
                    o_gen_NPackedDtrsPCAY0[i] = i_gen_NPackedDtrsPCAY0[i];
                    o_gen_NPackedDtrsPCAZ0[i] = i_gen_NPackedDtrsPCAZ0[i];
                    o_gen_NPackedDtrsPCAX1[i] = i_gen_NPackedDtrsPCAX1[i];
                    o_gen_NPackedDtrsPCAY1[i] = i_gen_NPackedDtrsPCAY1[i];
                    o_gen_NPackedDtrsPCAZ1[i] = i_gen_NPackedDtrsPCAZ1[i];
                    o_gen_NPackedDtrsPCAX2[i] = i_gen_NPackedDtrsPCAX2[i];
                    o_gen_NPackedDtrsPCAY2[i] = i_gen_NPackedDtrsPCAY2[i];
                    o_gen_NPackedDtrsPCAZ2[i] = i_gen_NPackedDtrsPCAZ2[i];
                    o_gen_NPackedDtrsPCAPhi1[i] = i_gen_NPackedDtrsPCAPhi1[i];
                    o_gen_NPackedDtrsPCAPhi2[i] = i_gen_NPackedDtrsPCAPhi2[i];
                    o_gen_NPackedDtrsPCAIndex1[i] = i_gen_NPackedDtrsPCAIndex1[i];
                    o_gen_NPackedDtrsPCAIndex2[i] = i_gen_NPackedDtrsPCAIndex2[i];
                }
                o_gen_NPackedDtrsHasKVFvertex = i_gen_NPackedDtrsHasKVFvertex;
                o_gen_NPackedDtrs_KVF_x = i_gen_NPackedDtrs_KVF_x;
                o_gen_NPackedDtrs_KVF_y = i_gen_NPackedDtrs_KVF_y;
                o_gen_NPackedDtrs_KVF_z = i_gen_NPackedDtrs_KVF_z;
                o_gen_NPackedDtrs_KVF_cxx = i_gen_NPackedDtrs_KVF_cxx;
                o_gen_NPackedDtrs_KVF_cyy = i_gen_NPackedDtrs_KVF_cyy;
                o_gen_NPackedDtrs_KVF_czz = i_gen_NPackedDtrs_KVF_czz;
                o_gen_NPackedDtrs_KVF_cyx = i_gen_NPackedDtrs_KVF_cyx;
                o_gen_NPackedDtrs_KVF_czy = i_gen_NPackedDtrs_KVF_czy;
                o_gen_NPackedDtrs_KVF_czx = i_gen_NPackedDtrs_KVF_czx;
                o_gen_NPackedDtrs_KVF_df = i_gen_NPackedDtrs_KVF_df;
                o_gen_NPackedDtrs_KVF_chi2 = i_gen_NPackedDtrs_KVF_chi2;
                o_gen_NPackedDtrs_KVF_ntracks = i_gen_NPackedDtrs_KVF_ntracks;
