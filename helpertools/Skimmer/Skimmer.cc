...
void Skimmer::Init_input_branches(TTree* tree)
{
    ...
    if(!isData){
         ...
         tree->SetBranchAddress("_gen_HT", &i_gen_HT, &bi__gen_HT);
    ...
    tree->SetBranchAddress("_lEleIsEB", i_lEleIsEB, &bi__lEleIsEB);
    tree->SetBranchAddress("_lEleIsEE", i_lEleIsEE, &bi__lEleIsEE);
    tree->SetBranchAddress("_lEleSuperClusterOverP", i_lEleSuperClusterOverP, &bi__lEleSuperClusterOverP);
    tree->SetBranchAddress("_lEleEcalEnergy", i_lEleEcalEnergy, &bi__lEleEcalEnergy);
    tree->SetBranchAddress("_lElefull5x5SigmaIetaIeta", i_lElefull5x5SigmaIetaIeta, &bi__lElefull5x5SigmaIetaIeta);
    tree->SetBranchAddress("_lEleDEtaInSeed", i_lEleDEtaInSeed, &bi__lEleDEtaInSeed);
    tree->SetBranchAddress("_lEleDeltaPhiSuperClusterTrackAtVtx", i_lEleDeltaPhiSuperClusterTrackAtVtx, &bi__lEleDeltaPhiSuperClusterTrackAtVtx);
    tree->SetBranchAddress("_lElehadronicOverEm", i_lElehadronicOverEm, &bi__lElehadronicOverEm);
    tree->SetBranchAddress("_lEleInvMinusPInv", i_lEleInvMinusPInv, &bi__lEleInvMinusPInv);
    tree->SetBranchAddress("_eleNumberInnerHitsMissing", i_eleNumberInnerHitsMissing, &bi__eleNumberInnerHitsMissing);
    tree->SetBranchAddress("_leptonMvatZq", i_leptonMvatZq, &bi__leptonMvatZq);
    tree->SetBranchAddress("_leptonMvaSUSY16", i_leptonMvaSUSY16, &bi__leptonMvaSUSY16);
    tree->SetBranchAddress("_leptonMvaTTH16", i_leptonMvaTTH16, &bi__leptonMvaTTH16);
    tree->SetBranchAddress("_leptonMvaSUSY17", i_leptonMvaSUSY17, &bi__leptonMvaSUSY17);
    tree->SetBranchAddress("_leptonMvaTTH17", i_leptonMvaTTH17, &bi__leptonMvaTTH17);
    tree->SetBranchAddress("_leptonMvatZqTTV16", i_leptonMvatZqTTV16, &bi__leptonMvatZqTTV16);
    tree->SetBranchAddress("_leptonMvatZqTTV17", i_leptonMvatZqTTV17, &bi__leptonMvatZqTTV17);
    tree->SetBranchAddress("_lHNLoose", i_lHNLoose, &bi__lHNLoose);
    tree->SetBranchAddress("_lHNFO", i_lHNFO, &bi__lHNFO);
    tree->SetBranchAddress("_lHNTight", i_lHNTight, &bi__lHNTight);
    ...
    tree->SetBranchAddress("_tauMuonVeto", i_tauMuonVeto, &bi__tauMuonVeto);
    tree->SetBranchAddress("_tauEleVeto", i_tauEleVeto, &bi__tauEleVeto);
    tree->SetBranchAddress("_decayModeFindingNew", i_decayModeFindingNew, &bi__decayModeFindingNew);
    tree->SetBranchAddress("_tauVLooseMvaNew", i_tauVLooseMvaNew, &bi__tauVLooseMvaNew);
    tree->SetBranchAddress("_tauLooseMvaNew", i_tauLooseMvaNew, &bi__tauLooseMvaNew);
    tree->SetBranchAddress("_tauMediumMvaNew", i_tauMediumMvaNew, &bi__tauMediumMvaNew);
    tree->SetBranchAddress("_tauTightMvaNew", i_tauTightMvaNew, &bi__tauTightMvaNew);
    tree->SetBranchAddress("_tauVTightMvaNew", i_tauVTightMvaNew, &bi__tauVTightMvaNew);
    tree->SetBranchAddress("_tauVTightMvaOld", i_tauVTightMvaOld, &bi__tauVTightMvaOld);
...
void Skimmer::Add_branches(TTree* tree)
{
    ...
    //tree->Branch("_lElectronSummer16MvaGP",             &o_lElectronMvaSummer16GP,               "_lElectronMvaSummer16GP[_nLight]/F");
    //tree->Branch("_lElectronSummer16MvaHZZ",            &o_lElectronMvaSummer16HZZ,              "_lElectronMvaSummer16HZZ[_nLight]/F");
    ...
    tree->Branch("_lEleIsEB",                           &o_lEleIsEB ,                            "_lEleIsEB[_nLight]/O");
    tree->Branch("_lEleIsEE",                           &o_lEleIsEE ,                            "_lEleIsEE[_nLight]/O");
    tree->Branch("_lEleSuperClusterOverP",              &o_lEleSuperClusterOverP ,               "_lEleSuperClusterOverP[_nLight]/D");
    tree->Branch("_lEleEcalEnergy",                     &o_lEleEcalEnergy ,                      "_lEleEcalEnergy[_nLight]/D");
    tree->Branch("_lElefull5x5SigmaIetaIeta",           &o_lElefull5x5SigmaIetaIeta ,            "_lElefull5x5SigmaIetaIeta[_nLight]/D");
    tree->Branch("_lEleDEtaInSeed",                     &o_lEleDEtaInSeed ,                      "_lEleDEtaInSeed[_nLight]/D");
    tree->Branch("_lEleDeltaPhiSuperClusterTrackAtVtx", &o_lEleDeltaPhiSuperClusterTrackAtVtx ,  "_lEleDeltaPhiSuperClusterTrackAtVtx[_nLight]/D");
    tree->Branch("_lElehadronicOverEm",                 &o_lElehadronicOverEm ,                  "_lElehadronicOverEm[_nLight]/D");
    tree->Branch("_lEleInvMinusPInv",                   &o_lEleInvMinusPInv ,                    "_lEleInvMinusPInv[_nLight]/D");
    tree->Branch("_eleNumberInnerHitsMissing",          &o_eleNumberInnerHitsMissing,            "_eleNumberInnerHitsMissing[_nLight]/D");
    ...
    tree->Branch("_leptonMvatZqTTV16",                  &o_leptonMvatZqTTV16,                    "_leptonMvatZqTTV16[_nLight]/D");
    tree->Branch("_leptonMvatZqTTV17",                  &o_leptonMvatZqTTV17,                    "_leptonMvatZqTTV17[_nLight]/D");
    ...
    //tree->Branch("_tauDecayMode",                       &o_tauDecayMode,                         "_tauDecayMode[_nL]/i");
    //tree->Branch("_decayModeFinding",                   &o_decayModeFinding,                     "_decayModeFinding[_nL]/O");
    //tree->Branch("_tauPOGVTight2017v2",                 &o_tauPOGVTight2017v2,                   "_tauPOGVTight2017v2[_nL]/O");
...
void Skimmer::Skim(TString skimcondition)
{
    ...
    for(Long64_t jentry = 0; jentry < nentries; ++jentry){
        ...
        if(skimcondition == "test"){
            ...
            for(unsigned i = 0; i < i_gen_nNdaughters; i++) o_gen_Ndaughters_pdg[i] = i_gen_Ndaughters_pdg[i];
            o_gen_nq = i_gen_nq;
            ...
            for(unsigned i = 0; i < i_nL; i++){
                ...
                o_tauMuonVeto[i] = i_tauMuonVeto[i];   
                o_tauEleVeto[i] = i_tauEleVeto[i];   
                o_decayModeFindingNew[i] = i_decayModeFindingNew[i];   
                o_tauVLooseMvaNew[i] = i_tauVLooseMvaNew[i];   
                o_tauLooseMvaNew[i] = i_tauLooseMvaNew[i];   
                o_tauMediumMvaNew[i] = i_tauMediumMvaNew[i];   
                o_tauTightMvaNew[i] = i_tauTightMvaNew[i];   
                o_tauVTightMvaNew[i] = i_tauVTightMvaNew[i];   
                o_tauVTightMvaOld[i] = i_tauVTightMvaOld[i];   
            ...
            for(unsigned i = 0; i < i_nLight; i++){
                ...
                o_lEleIsEB[i] = i_lEleIsEB[i];
                o_lEleIsEE[i] = i_lEleIsEE[i];
                o_lEleSuperClusterOverP[i] = i_lEleSuperClusterOverP[i];
                o_lEleEcalEnergy[i] = i_lEleEcalEnergy[i];
                o_lElefull5x5SigmaIetaIeta[i] = i_lElefull5x5SigmaIetaIeta[i];
                o_lEleDEtaInSeed[i] = i_lEleDEtaInSeed[i];
                o_lEleDeltaPhiSuperClusterTrackAtVtx[i] = i_lEleDeltaPhiSuperClusterTrackAtVtx[i];
                o_lElehadronicOverEm[i] = i_lElehadronicOverEm[i];
                o_lEleInvMinusPInv[i] = i_lEleInvMinusPInv[i];
                o_eleNumberInnerHitsMissing[i] = i_eleNumberInnerHitsMissing[i];
                o_leptonMvatZq[i] = i_leptonMvatZq[i];
                o_leptonMvaSUSY16[i] = i_leptonMvaSUSY16[i];   
                o_leptonMvaTTH16[i] = i_leptonMvaTTH16[i];   
                o_leptonMvaSUSY17[i] = i_leptonMvaSUSY17[i];   
                o_leptonMvaTTH17[i] = i_leptonMvaTTH17[i];   
                o_leptonMvatZqTTV16[i] = i_leptonMvatZqTTV16[i];   
                o_leptonMvatZqTTV17[i] = i_leptonMvatZqTTV17[i];   
                o_lHNLoose[i] = i_lHNLoose[i];   
                o_lHNFO[i] = i_lHNFO[i];   
                o_lHNTight[i] = i_lHNTight[i];   
