...
int main(int argc, char * argv[])
{
    ...
    PFNcuts["e_2016_2GeV"] = get_PFNcut(5, 0, true, false);
    PFNcuts["e_2016_5GeV"] = get_PFNcut(5, 0, true, false);
    PFNcuts["e_2016_8GeV"] = get_PFNcut(10, 0, true, false);
    PFNcuts["e_2016_12GeV"] = get_PFNcut(10, 0, true, false);
    PFNcuts["m_2016_2GeV"] = get_PFNcut(5, 1, true, false);
    PFNcuts["m_2016_5GeV"] = get_PFNcut(5, 1, true, false);
    PFNcuts["m_2016_8GeV"] = get_PFNcut(10, 1, true, false);
    PFNcuts["m_2016_12GeV"] = get_PFNcut(10, 1, true, false);
    PFNcuts["e_2017_2GeV"] = get_PFNcut(5, 0, false, true);
    PFNcuts["e_2017_5GeV"] = get_PFNcut(5, 0, false, true);
    PFNcuts["e_2017_8GeV"] = get_PFNcut(10, 0, false, true);
    PFNcuts["e_2017_12GeV"] = get_PFNcut(10, 0, false, true);
    PFNcuts["m_2017_2GeV"] = get_PFNcut(5, 1, false, true);
    PFNcuts["m_2017_5GeV"] = get_PFNcut(5, 1, false, true);
    PFNcuts["m_2017_8GeV"] = get_PFNcut(10, 1, false, true);
    PFNcuts["m_2017_12GeV"] = get_PFNcut(10, 1, false, true);
    PFNcuts["e_2018_2GeV"] = get_PFNcut(5, 0, false, false);
    PFNcuts["e_2018_5GeV"] = get_PFNcut(5, 0, false, false);
    PFNcuts["e_2018_8GeV"] = get_PFNcut(10, 0, false, false);
    PFNcuts["e_2018_12GeV"] = get_PFNcut(10, 0, false, false);
    PFNcuts["m_2018_2GeV"] = get_PFNcut(5, 1, false, false);
    PFNcuts["m_2018_5GeV"] = get_PFNcut(5, 1, false, false);
    PFNcuts["m_2018_8GeV"] = get_PFNcut(10, 1, false, false);
    PFNcuts["m_2018_12GeV"] = get_PFNcut(10, 1, false, false);

    PFNcuts["e_2016_5Bkg"] = get_PFNcut(5, 0, true, false);
    PFNcuts["e_2016_10Bkg"] = get_PFNcut(10, 0, true, false);
    PFNcuts["m_2016_5Bkg"] = get_PFNcut(5, 1, true, false);
    PFNcuts["m_2016_10Bkg"] = get_PFNcut(10, 1, true, false);
    PFNcuts["e_2017_5Bkg"] = get_PFNcut(5, 0, false, true);
    PFNcuts["e_2017_10Bkg"] = get_PFNcut(10, 0, false, true);
    PFNcuts["m_2017_5Bkg"] = get_PFNcut(5, 1, false, true);
    PFNcuts["m_2017_10Bkg"] = get_PFNcut(10, 1, false, true);
    PFNcuts["e_2018_5Bkg"] = get_PFNcut(5, 0, false, false);
    PFNcuts["e_2018_10Bkg"] = get_PFNcut(10, 0, false, false);
    PFNcuts["m_2018_5Bkg"] = get_PFNcut(5, 1, false, false);
    PFNcuts["m_2018_10Bkg"] = get_PFNcut(10, 1, false, false);
