...
./test/run_plots.sh test/sampleLists/plots_METResolution_mm_datavsMC.txt 3 a_plotsfull_mm.out
...
./test/run_plots.sh test/sampleLists/plots_METResolution_ee_datavsMC.txt 3 a_plotsfull_ee.out
