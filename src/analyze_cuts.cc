...
int main(int argc, char * argv[])
{
    ...
    double _bkg_displ_OS_e_dphi_eff = hists["bkg_displ_OS_e_cuts"]->GetBinContent(8) / hists["bkg_displ_OS_e_cuts"]->GetBinContent(7);
    double _3GeV_displ_SS_mu_dphi_eff = hists["3GeV_displ_SS_mu_cuts"]->GetBinContent(8) / hists["3GeV_displ_SS_mu_cuts"]->GetBinContent(7);
    double _3GeV_displ_OS_mu_dphi_eff = hists["3GeV_displ_OS_mu_cuts"]->GetBinContent(8) / hists["3GeV_displ_OS_mu_cuts"]->GetBinContent(7);
    double _3GeV_displ_SS_e_dphi_eff = hists["3GeV_displ_SS_e_cuts"]->GetBinContent(8) / hists["3GeV_displ_SS_e_cuts"]->GetBinContent(7);
    double _3GeV_displ_OS_e_dphi_eff = hists["3GeV_displ_OS_e_cuts"]->GetBinContent(8) / hists["3GeV_displ_OS_e_cuts"]->GetBinContent(7);
    double _7GeV_displ_SS_mu_dphi_eff = hists["7GeV_displ_SS_mu_cuts"]->GetBinContent(8) / hists["7GeV_displ_SS_mu_cuts"]->GetBinContent(7);
    double _7GeV_displ_OS_mu_dphi_eff = hists["7GeV_displ_OS_mu_cuts"]->GetBinContent(8) / hists["7GeV_displ_OS_mu_cuts"]->GetBinContent(7);
    double _7GeV_displ_SS_e_dphi_eff = hists["7GeV_displ_SS_e_cuts"]->GetBinContent(8) / hists["7GeV_displ_SS_e_cuts"]->GetBinContent(7);
    double _7GeV_displ_OS_e_dphi_eff = hists["7GeV_displ_OS_e_cuts"]->GetBinContent(8) / hists["7GeV_displ_OS_e_cuts"]->GetBinContent(7);
    double _10GeV_displ_SS_mu_dphi_eff = hists["10GeV_displ_SS_mu_cuts"]->GetBinContent(8) / hists["10GeV_displ_SS_mu_cuts"]->GetBinContent(7);
    double _10GeV_displ_OS_mu_dphi_eff = hists["10GeV_displ_OS_mu_cuts"]->GetBinContent(8) / hists["10GeV_displ_OS_mu_cuts"]->GetBinContent(7);
