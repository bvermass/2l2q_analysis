...
void full_analyzer::Init(TTree *tree)
{
   ...
   if(tree->FindBranch("_weight")){ // check if we're dealing with data or MC, can't use isData yet because it's not yet initialized
        ...
        fChain->SetBranchAddress("_gen_NPackedDtrsRecodR", _gen_NPackedDtrsRecodR, &b__gen_NPackedDtrsRecodR);
        fChain->SetBranchAddress("_gen_NPackedDtrsRecodptoverpt", _gen_NPackedDtrsRecodptoverpt, &b__gen_NPackedDtrsRecodptoverpt);
        fChain->SetBranchAddress("_gen_NPackedDtrsRecoPt", _gen_NPackedDtrsRecoPt, &b__gen_NPackedDtrsRecoPt);
        fChain->SetBranchAddress("_gen_NPackedDtrsRecoEta", _gen_NPackedDtrsRecoEta, &b__gen_NPackedDtrsRecoEta);
        fChain->SetBranchAddress("_gen_NPackedDtrsRecoPhi", _gen_NPackedDtrsRecoPhi, &b__gen_NPackedDtrsRecoPhi);
        fChain->SetBranchAddress("_gen_NPackedDtrsRecoE", _gen_NPackedDtrsRecoE, &b__gen_NPackedDtrsRecoE);
        fChain->SetBranchAddress("_gen_NPackedDtrsRecoPdgId", _gen_NPackedDtrsRecoPdgId, &b__gen_NPackedDtrsRecoPdgId);
        fChain->SetBranchAddress("_gen_NPackedDtrsRecodxy", _gen_NPackedDtrsRecodxy, &b__gen_NPackedDtrsRecodxy);
        fChain->SetBranchAddress("_gen_NPackedDtrsRecodz", _gen_NPackedDtrsRecodz, &b__gen_NPackedDtrsRecodz);
        fChain->SetBranchAddress("_gen_NPackedDtrsHasReco", _gen_NPackedDtrsHasReco, &b__gen_NPackedDtrsHasReco);
        fChain->SetBranchAddress("_gen_nNPackedDtrsPCA", &_gen_nNPackedDtrsPCA, &b__gen_nNPackedDtrsPCA);
        fChain->SetBranchAddress("_gen_NPackedDtrsPCADist", _gen_NPackedDtrsPCADist, &b__gen_NPackedDtrsPCADist);
        fChain->SetBranchAddress("_gen_NPackedDtrsPCAX0", _gen_NPackedDtrsPCAX0, &b__gen_NPackedDtrsPCAX0);
        fChain->SetBranchAddress("_gen_NPackedDtrsPCAY0", _gen_NPackedDtrsPCAY0, &b__gen_NPackedDtrsPCAY0);
        fChain->SetBranchAddress("_gen_NPackedDtrsPCAZ0", _gen_NPackedDtrsPCAZ0, &b__gen_NPackedDtrsPCAZ0);
        fChain->SetBranchAddress("_gen_NPackedDtrsPCAX1", _gen_NPackedDtrsPCAX1, &b__gen_NPackedDtrsPCAX1);
        fChain->SetBranchAddress("_gen_NPackedDtrsPCAY1", _gen_NPackedDtrsPCAY1, &b__gen_NPackedDtrsPCAY1);
        fChain->SetBranchAddress("_gen_NPackedDtrsPCAZ1", _gen_NPackedDtrsPCAZ1, &b__gen_NPackedDtrsPCAZ1);
        fChain->SetBranchAddress("_gen_NPackedDtrsPCAX2", _gen_NPackedDtrsPCAX2, &b__gen_NPackedDtrsPCAX2);
        fChain->SetBranchAddress("_gen_NPackedDtrsPCAY2", _gen_NPackedDtrsPCAY2, &b__gen_NPackedDtrsPCAY2);
        fChain->SetBranchAddress("_gen_NPackedDtrsPCAZ2", _gen_NPackedDtrsPCAZ2, &b__gen_NPackedDtrsPCAZ2);
        fChain->SetBranchAddress("_gen_NPackedDtrsPCAPhi1", _gen_NPackedDtrsPCAPhi1, &b__gen_NPackedDtrsPCAPhi1);
        fChain->SetBranchAddress("_gen_NPackedDtrsPCAPhi2", _gen_NPackedDtrsPCAPhi2, &b__gen_NPackedDtrsPCAPhi2);
        fChain->SetBranchAddress("_gen_NPackedDtrsPCAIndex1", _gen_NPackedDtrsPCAIndex1, &b__gen_NPackedDtrsPCAIndex1);
        fChain->SetBranchAddress("_gen_NPackedDtrsPCAIndex2", _gen_NPackedDtrsPCAIndex2, &b__gen_NPackedDtrsPCAIndex2);
        fChain->SetBranchAddress("_gen_NPackedDtrsHasKVFvertex", &_gen_NPackedDtrsHasKVFvertex, &b__gen_NPackedDtrsHasKVFvertex);
        fChain->SetBranchAddress("_gen_NPackedDtrs_KVF_x", &_gen_NPackedDtrs_KVF_x, &b__gen_NPackedDtrs_KVF_x);
        fChain->SetBranchAddress("_gen_NPackedDtrs_KVF_y", &_gen_NPackedDtrs_KVF_y, &b__gen_NPackedDtrs_KVF_y);
        fChain->SetBranchAddress("_gen_NPackedDtrs_KVF_z", &_gen_NPackedDtrs_KVF_z, &b__gen_NPackedDtrs_KVF_z);
        fChain->SetBranchAddress("_gen_NPackedDtrs_KVF_cxx", &_gen_NPackedDtrs_KVF_cxx, &b__gen_NPackedDtrs_KVF_cxx);
        fChain->SetBranchAddress("_gen_NPackedDtrs_KVF_cyy", &_gen_NPackedDtrs_KVF_cyy, &b__gen_NPackedDtrs_KVF_cyy);
        fChain->SetBranchAddress("_gen_NPackedDtrs_KVF_czz", &_gen_NPackedDtrs_KVF_czz, &b__gen_NPackedDtrs_KVF_czz);
        fChain->SetBranchAddress("_gen_NPackedDtrs_KVF_cyx", &_gen_NPackedDtrs_KVF_cyx, &b__gen_NPackedDtrs_KVF_cyx);
        fChain->SetBranchAddress("_gen_NPackedDtrs_KVF_czy", &_gen_NPackedDtrs_KVF_czy, &b__gen_NPackedDtrs_KVF_czy);
        fChain->SetBranchAddress("_gen_NPackedDtrs_KVF_czx", &_gen_NPackedDtrs_KVF_czx, &b__gen_NPackedDtrs_KVF_czx);
        fChain->SetBranchAddress("_gen_NPackedDtrs_KVF_df", &_gen_NPackedDtrs_KVF_df, &b__gen_NPackedDtrs_KVF_df);
        fChain->SetBranchAddress("_gen_NPackedDtrs_KVF_chi2", &_gen_NPackedDtrs_KVF_chi2, &b__gen_NPackedDtrs_KVF_chi2);
        fChain->SetBranchAddress("_gen_NPackedDtrs_KVF_ntracks", &_gen_NPackedDtrs_KVF_ntracks, &b__gen_NPackedDtrs_KVF_ntracks);
   ...
   if(tree->FindBranch("_nV0s")){ //check if we're dealing with a Kshort sample
      fChain->SetBranchAddress( "_nV0s",                   &_nV0s,                &b__nV0s);
      fChain->SetBranchAddress( "_V0InvMass",              _V0InvMass,           &b__V0InvMass);
      fChain->SetBranchAddress( "_V0Type",                 _V0Type,              &b__V0Type);
      fChain->SetBranchAddress( "_V0X",                    _V0X,                 &b__V0X);
      fChain->SetBranchAddress( "_V0Y",                    _V0Y,                 &b__V0Y);
      fChain->SetBranchAddress( "_V0Z",                    _V0Z,                 &b__V0Z);
      fChain->SetBranchAddress( "_V0RPV",                  _V0RPV,               &b__V0RPV);
      fChain->SetBranchAddress( "_V0RBS",                  _V0RBS,               &b__V0RBS);
      fChain->SetBranchAddress( "_V0Px",                   _V0Px,                &b__V0Px);
      fChain->SetBranchAddress( "_V0Py",                   _V0Py,                &b__V0Py);
      fChain->SetBranchAddress( "_V0Pz",                   _V0Pz,                &b__V0Pz);
      fChain->SetBranchAddress( "_V0Pt",                   _V0Pt,                &b__V0Pt);
      fChain->SetBranchAddress( "_V0Eta",                  _V0Eta,               &b__V0Eta);
      fChain->SetBranchAddress( "_V0Phi",                  _V0Phi,               &b__V0Phi);
      fChain->SetBranchAddress( "_V0DCA",                  _V0DCA,               &b__V0DCA);
      fChain->SetBranchAddress( "_V0PCAX",                 _V0PCAX,              &b__V0PCAX);
      fChain->SetBranchAddress( "_V0PCAY",                 _V0PCAY,              &b__V0PCAY);
      fChain->SetBranchAddress( "_V0PCAZ",                 _V0PCAZ,              &b__V0PCAZ);
      fChain->SetBranchAddress( "_V0VtxNormChi2",          _V0VtxNormChi2,       &b__V0VtxNormChi2);
      fChain->SetBranchAddress( "_V0RSigPV",               _V0RSigPV,            &b__V0RSigPV);
      fChain->SetBranchAddress( "_V0RSigBS",               _V0RSigBS,            &b__V0RSigBS);
      fChain->SetBranchAddress( "_V0PxPos",                _V0PxPos,             &b__V0PxPos);
      fChain->SetBranchAddress( "_V0PyPos",                _V0PyPos,             &b__V0PyPos);
      fChain->SetBranchAddress( "_V0PzPos",                _V0PzPos,             &b__V0PzPos);
      fChain->SetBranchAddress( "_V0PtPos",                _V0PtPos,             &b__V0PtPos);
      fChain->SetBranchAddress( "_V0PxNeg",                _V0PxNeg,             &b__V0PxNeg);
      fChain->SetBranchAddress( "_V0PyNeg",                _V0PyNeg,             &b__V0PyNeg);
      fChain->SetBranchAddress( "_V0PzNeg",                _V0PzNeg,             &b__V0PzNeg);
      fChain->SetBranchAddress( "_V0PtNeg",                _V0PtNeg,             &b__V0PtNeg);
      fChain->SetBranchAddress( "_V0EtaPos",               _V0EtaPos,            &b__V0EtaPos);
      fChain->SetBranchAddress( "_V0EtaNeg",               _V0EtaNeg,            &b__V0EtaNeg);
      fChain->SetBranchAddress( "_V0PhiPos",               _V0PhiPos,            &b__V0PhiPos);
      fChain->SetBranchAddress( "_V0PhiNeg",               _V0PhiNeg,            &b__V0PhiNeg);
      fChain->SetBranchAddress( "_V0NHitsPos",             _V0NHitsPos,          &b__V0NHitsPos);
      fChain->SetBranchAddress( "_V0NHitsNeg",             _V0NHitsNeg,          &b__V0NHitsNeg);
      fChain->SetBranchAddress( "_V0NPixHitsPos",          _V0NPixHitsPos,       &b__V0NPixHitsPos);
      fChain->SetBranchAddress( "_V0NPixHitsNeg",          _V0NPixHitsNeg,       &b__V0NPixHitsNeg);
      fChain->SetBranchAddress( "_V0D0Pos",                _V0D0Pos,             &b__V0D0Pos);
      fChain->SetBranchAddress( "_V0DzPos",                _V0DzPos,             &b__V0DzPos);
      fChain->SetBranchAddress( "_V0D0Neg",                _V0D0Neg,             &b__V0D0Neg);
      fChain->SetBranchAddress( "_V0DzNeg",                _V0DzNeg,             &b__V0DzNeg);
      fChain->SetBranchAddress( "_V0IsoPos",               _V0IsoPos,            &b__V0IsoPos);
      fChain->SetBranchAddress( "_V0IsoNeg",               _V0IsoNeg,            &b__V0IsoNeg);
      fChain->SetBranchAddress( "_V0LooseQualityPos",      _V0LooseQualityPos,   &b__V0LooseQualityPos);
      fChain->SetBranchAddress( "_V0LooseQualityNeg",      _V0LooseQualityNeg,   &b__V0LooseQualityNeg);
      fChain->SetBranchAddress( "_V0TransIPSigPos",        _V0TransIPSigPos,     &b__V0TransIPSigPos);
      fChain->SetBranchAddress( "_V0TransIPSigNeg",        _V0TransIPSigNeg,     &b__V0TransIPSigNeg);
      fChain->SetBranchAddress( "_V0PtRatioPos",           _V0PtRatioPos,        &b__V0PtRatioPos);
      fChain->SetBranchAddress( "_V0PtRatioNeg",           _V0PtRatioNeg,        &b__V0PtRatioNeg);
      fChain->SetBranchAddress( "_V0PtRelPos",             _V0PtRelPos,          &b__V0PtRelPos);
      fChain->SetBranchAddress( "_V0PtRelNeg",             _V0PtRelNeg,          &b__V0PtRelNeg);
   }
}
